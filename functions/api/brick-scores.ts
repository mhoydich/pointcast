 ...
 *   - `bc:scores`                       → all-time, all arcade games (choir · quartet · 2600)   [unchanged]
 ...
 *
 * GET  [?period=all|week|day] [&game=choir|quartet|2600|daily] [&day=YYYY-MM-DD]
...
const KEY = 'bc:scores';
const GAMES = new Set(['choir', 'quartet', '2600', 'daily']);
const KEEP = 20;
