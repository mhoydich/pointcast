...
import { g as renderElement, h as generateCspDigest, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, i as createHeadAndContent, r as renderComponent } from './prerender_CmTjnOuJ.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CRg1OH1T.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_virtual_astro_get-image_D0yxLB9Z.mjs').then(n => n._);
