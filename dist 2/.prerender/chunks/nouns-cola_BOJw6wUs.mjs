const payload = {
  ...
  fundraising: {
    targetUsd: 12e4,
    uses: [
      { item: "Recipe R&D and lab validation", amountUsd: 12e3 },
      { item: "Pilot can run deposit", amountUsd: 38e3 },
      { item: "Inventory, freight, cold storage", amountUsd: 44e3 },
      { item: "PointCast launch media and sampling", amountUsd: 16e3 },
      { item: "Compliance, reserve, surprises", amountUsd: 1e4 }
    ],
  ...
  inventoryFinancingPlan: {
    ...
    targetFacilityUsd: 12e4,
    uses: [
      { use: "Co-packer deposit", amountUsd: 38e3, source: "facility + crate sponsors" },
      { use: "Landed inventory", amountUsd: 44e3, source: "facility + case preorders" },
      { use: "Fulfillment float", amountUsd: 14e3, source: "case preorders" },
      { use: "Retail terms buffer", amountUsd: 14e3, source: "facility reserve" },
      { use: "First-loss reserve", amountUsd: 1e4, source: "treasury / sponsor holdback" }
    ],
    gatesBeforeRelease: [
      "formula locked",
