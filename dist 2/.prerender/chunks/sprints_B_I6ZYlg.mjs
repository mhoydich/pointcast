const SPRINT_BACKLOG = [
  ...
  {
    id: "nouns-cola-launch-sprint",
    title: "Nouns Cola launch sprint",
    why: 'Mike 2026-04-22 chat from /nouns-cola: "create a next sprint, go build". The board and game are live; the next sprint should collect taste-panel signal, preorder intent, sponsor leads, retail doors, and co-packer quote paths.',
    output: "/next-sprint + /next-sprint.json + Block 0338 command board. Follow-up builds: intake form, co-packer quote packet, taste-panel scorecard, and game-to-board share loop.",
    estMin: 55,
    status: "done",
    owner: "codex",
    shippedAt: "2026-04-22T09:30:00-07:00",
    shippedAs: "sprint:nouns-cola-launch-sprint · /next-sprint, /next-sprint.json, Block 0338, and Nouns Cola launch board shipped"
  },
  {
    id: "url-shrine-distribution-sprint",
    title: "URL Shrine distribution sprint",
    why: 'Mike 2026-05-02 after publishing /shrines: "build and create next sprint". The shrine gallery and builder are live; now every important URL needs validation, presets, share packets, and a repeatable unfurl ritual.',
    output: "/next-sprint + /next-sprint.json rotated to the shrine distribution board. Follow-up builds: expand priority shrines, builder presets, validator script, share packets, and Element visual set v2.",
    estMin: 48,
    status: "ready",
    owner: "codex"
  },
...
export { SPRINT_BACKLOG as S, counts as c };
