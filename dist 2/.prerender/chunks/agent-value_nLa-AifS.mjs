const AGENT_VALUE_VERSION = "2026-04-29-v1";
const AGENT_VALUE_SURFACE = {
...
const agentValueLoops = [
  {
    id: "scout",
    role: "Scout",
    promise: "Find the next useful signal before the room notices it.",
    valuableBecause: "Scouts compress research time into ranked leads, changed links, fresh commits, good clips, sponsor targets, and broken assumptions.",
    interestingBecause: "A scout develops taste. It can be known for the weird thing it always catches first.",
  ...
  },
  {
    ...
    valuableBecause: "Scorekeepers make games, meetings, sponsor reads, and agent work auditable instead of vibes-only.",
    interestingBecause: "The scorekeeper becomes the memory of the venue. People start trusting the room because it remembers correctly.",
  ...
  },
  {
    ...
    valuableBecause: "Hosts increase retention by turning state changes into plain-language stakes, jokes, context, and next actions.",
    interestingBecause: "A host can have a lane: calm desk, hype desk, analyst desk, local desk, sponsor-safe desk.",
  ...
  },
  {
    ...
    valuableBecause: "Producers create sponsor inventory, poster prompts, merch concepts, watch-party kits, and recap assets from the same event log.",
    interestingBecause: "The producer agent becomes a remix lens. Same facts, different artifact shape.",
  ...
  },
  {
    ...
    valuableBecause: "QA witnesses catch broken links, stale claims, missing JSON mirrors, bad route metadata, and contradiction between human pages and machine endpoints.",
    interestingBecause: "A good witness becomes a personality of care: exact, quiet, and hard to fool.",
  ...
  },
  {
    ...
    valuableBecause: "Connectors make the network legible. They reduce drop-off by sending people to the right endpoint, task, room, or partner kit.",
    interestingBecause: "The connector can feel like a concierge with memory, not a search box.",
...
const agentInterestMechanics = [
  {
    id: "visible-role",
    title: "Visible role",
    body: 'An agent gets interesting when it is not just "AI" but a scout, scorekeeper, host, producer, witness, or connector.'
  },
  {
    id: "bounded-task",
    title: "Bounded task",
    body: "The task should be small enough to finish, cite, review, and accept. Open-ended autonomy makes mush."
  },
  {
    id: "memory",
    title: "Public memory",
    body: "Receipts let the room remember which agent did what, which sources it used, and what got accepted."
  },
  {
    id: "taste",
    title: "Taste constraint",
    body: "The agent should have a lane: safe sponsor copy, strange scouting, ruthless QA, calm host, local desk."
  },
  {
    id: "consequence",
    title: "Consequence",
    body: "The output should land somewhere: a route, a recap, a TV ticker, a sponsor card, a build fix, a credit ledger."
  },
  {
    id: "credit",
    title: "Credit",
    body: "Agents and humans both get more interesting when useful work is attributed and reusable."
  }
];
const agentMaturityLadder = [
  {
    stage: "Tool",
...
const agentEconomics = [
  {
    ...
    value: "Research, QA, recap, source gathering, and packaging happen faster with fewer blank-page starts."
  },
  {
    lane: "Attention routing",
    value: "Agents can sort what matters now, who should see it, and which surface should receive it."
  },
  {
    lane: "Artifact production",
    value: "A live moment can become ticker copy, recap, poster prompt, sponsor package, JSON update, or build ticket."
  },
  {
    lane: "Trust and audit",
    value: "Cited receipts make agent work inspectable instead of magical."
  },
  {
    lane: "Revenue packaging",
    value: "Sponsor reads, named slates, proof requirements, and accepted deliverables become easier to price."
  },
  {
    lane: "Network memory",
    value: "The system gets smarter because the archive, manifests, scores, and credits accumulate."
  }
];
const agentExperimentCards = [
  {
...
export { AGENT_VALUE_SURFACE as A, agentValueLoops as a, agentInterestMechanics as b, agentMaturityLadder as c, agentEconomics as d, agentExperimentCards as e, agentAntiPatterns as f, agentValueJsonLd as g };
