const JOIN_SYSTEM = {
  ...
  source: "Gmail idea overview from 2026-04-30 plus Mike chat on 2026-05-05.",
  thesis: "Map scattered human and creative identity, make it legible, then route collaboration, opportunity, capital, and expression through small claimable tasks.",
  loop: [
    {
      id: "map",
      label: "Map",
  ...
  projects: [
    {
      ...
      summary: "AI-powered identity assembly for creative and technical people: discover scattered profiles, build a shareable identity map, and suggest high-fit collaborators.",
      firstWedge: "A profile assembler for one creative/technical person. Input 5-8 links, output a beautiful identity map, collaboration suggestions, and a public page.",
      agentTasks: [
      ...
      peopleTasks: [
        ...
        "Decide the first niche: AI builders, artists, music people, founders, or local creatives."
      ],
      artifact: "/join#cartography"
    },
    {
      id: "bosslist",
      name: "BossList",
      ...
      summary: "Vertical lists of specialists, richer auto-built profiles, lightweight scoring, jobs, recruiters, and contact importers.",
      firstWedge: "One public list that people would actually search for, with 25 hand-curated profiles and a clear opportunity hook.",
      agentTasks: [
    ...
    },
    {
      ...
      summary: "A peer-to-peer trust and reputation graph: public keys, signed transactions, social graph, trust rank, verification, reviews, and contracts.",
      firstWedge: "A non-chain reputation receipt format for PointCast contributors: who did what, who verified it, and where the artifact lives.",
      agentTasks: [
    ...
    },
    {
      ...
      summary: "Make crypto feel like messaging and identity: send tokens by email or text, show public wallet pages, and let groups distribute tokens without finance-first UX.",
      firstWedge: "Use the pattern as a design reference for PointCast claims, drops, badges, and contribution receipts before rebuilding wallet infrastructure.",
      agentTasks: [
    ...
    },
    {
      ...
      summary: "A mobile-first image markup and sharing surface: choose image, add text, apply templates or overlays, append dynamic stamps, and send.",
      firstWedge: "A PointCast share-card builder preset that turns any block or idea into a sendable image.",
      agentTasks: [
    ...
    },
    {
      ...
      summary: "A generative music label or service for personalized songs, visual worlds, licensing, playlists, and virtual performances.",
      firstWedge: "Do not start with a label. Start with one small music-visual ritual or YeePlayer track pack that people replay.",
      agentTasks: [
    ...
    },
    {
      ...
      summary: "A system for turning raw ideas from people and agents into early explorable product plans with effort, risks, first users, and v0 scope.",
      firstWedge: "This join system: every idea becomes a card, every card becomes tasks, every task has an owner and artifact.",
      agentTasks: [
