const PROTOCOL_VERSION = "pcp-1.0.4";
const PROTOCOL_PACKET_VERSION = "pcp-1.0";
const PROTOCOL_PACKET_MEDIA_TYPE = "pcp-1.0/block-packet+json";
const PROTOCOL_NAME = "PointCast Peer Message Protocol";
const PROTOCOL_SHORT_NAME = "PCP/1";
const PROTOCOL_UPDATED_AT = "2026-04-28T09:10:00Z";
const PROTOCOL_STORAGE_KEYS = {
...
const PROTOCOL_CANONICAL_JSON_RULES = [
...
const PROTOCOL_VALIDATION_RULES = [
...
const PROTOCOL_COMPATIBILITY_NOTES = [
...
const PROTOCOL_V2_SIMPLE_FRIENDS = {
  status: "draft",
...
const PROTOCOL_V2_CHAIN_MESSENGER = {
...
function buildProtocolManifest() {
  return {
    ...
    purpose: "A peer-to-peer messaging protocol for 2026 and 2027: signed Block packets, replaceable relays, local-first logs, and first-class human plus agent peers.",
...
export { PROTOCOL_PACKET_EXAMPLE as P, PROTOCOL_SHORT_NAME as a, buildProtocolManifest as b, PROTOCOL_VERSION as c, PROTOCOL_NAME as d, PROTOCOL_V2_CHAIN_MESSENGER as e, PROTOCOL_V2_SIMPLE_FRIENDS as f, PROTOCOL_PACKET_MEDIA_TYPE as g, PROTOCOL_DISCOVERY as h, PROTOCOL_PRINCIPLES as i, PROTOCOL_LAYERS as j, PROTOCOL_STORAGE_KEYS as k, PROTOCOL_CANONICAL_JSON_RULES as l, PROTOCOL_VALIDATION_RULES as m, PROTOCOL_RECEIPT_TYPES as n, PROTOCOL_AGENT_RECEIPTS as o, PROTOCOL_COMPATIBILITY_NOTES as p, PROTOCOL_ROADMAP as q, PROTOCOL_UPDATED_AT as r };
