import { P as PLANTING_YIELD_SITES, N as NATIVE_PLANTING_PALETTE, a as PLANTING_VALUE_SYSTEM, A as ANCHOR } from './local_DC-fTB3e.mjs';

const GET = async () => {
  const payload = {
    $schema: "https://pointcast.xyz/nature-yield.json",
    name: "PointCast · Native Planting Value Yield",
    description: "A practical, non-financial value-yield system for turning Block 0331 into site plans, plant mixes, care loops, and measurable local habitat outcomes.",
    ...
    outputContract: {
      ...
      reportBack: "Return site type, final plant mix, survival, bloom, water observations, and one photo or note to the PointCast local channel."
    },
    links: {
