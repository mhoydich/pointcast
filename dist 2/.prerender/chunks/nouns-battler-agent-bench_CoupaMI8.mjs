const NOUNS_BATTLER_AGENT_BENCH_VERSION = "2.0.0";
const NOUNS_BATTLER_AGENT_TASKS = [
  {
  ...
  },
  {
    ...
    prompt: "Open Sports Reenactment Mission Control, choose one goal and one result shape, then produce the host rundown, agent task, share receipt, and proof checklist for a typed sports result.",
    expectedOutput: "A compact mission package with launch URL, source result, field, host line, agent task, share receipt, proof checklist, and guardrail.",
    shareFormat: "MISSION: {league} {winner} over {loser}; goal {goal}; field {field}; launch {url}; guardrail {text}."
  }
];
const NOUNS_BATTLER_AGENT_PROMPTS = [
  {
...
const NOUNS_BATTLER_AGENT_PROMPT_KIT = {
  version: "1.0.0",
  ...
  prompts: [
    ...
    },
    {
      ...
      prompt: "You are the sports reenactment mission producer. Pick one goal and one shape, enter a sports result, then return the launch URL, host rundown, agent task, share receipt, and proof checklist.",
      successCriteria: [
      ...
      outputFormat: "MISSION PACKAGE: url {url}; goal {goal}; shape {shape}; launch {launch}; host {rundown}; agent {task}; share {receipt}; proof {checklist}; guardrail {text}.",
      validation: "Do not claim official replay, live data, odds, betting, prediction, payout, or forced outcome."
    }
  ]
};
const NOUNS_BATTLER_AGENT_TASK_PACKS = [
  {
...
const NOUNS_BATTLER_ASSET_FACTORY = {
...
const NOUNS_BATTLER_BUSINESS_MODEL = {
...
const NOUNS_BATTLER_FEATURED_NOUNS = [
  {
    id: "noun-12",
    number: 12,
    name: "Noun 12",
...
const NOUNS_BATTLER_SEASON_HIGHLIGHTS = [
  {
    season: "Season 1",
...
const NOUNS_BATTLER_SPONSORSHIP_MARKET = {
...
const NOUNS_BATTLER_PARTICIPANT_YIELD = {
...
const NOUNS_BATTLER_WORK_CONTRIBUTION_TYPES = [
  {
    id: "scout-report",
    label: "Scout Report",
...
const NOUNS_BATTLER_BROADCAST_DIRECTOR = {
...
const NOUNS_BATTLER_ROOTING_LAYER = {
...
const NOUNS_BATTLER_NOUNS_BOWL_HYPE = {
...
const NOUNS_BATTLER_SEASON_ARCHIVE = {
...
const NOUNS_BATTLER_PRODUCTION_DESK = {
...
const NOUNS_BATTLER_CLAIM_BOARD_TASKS = [
  {
...
const NOUNS_BATTLER_CLAIM_BOARD = {
...
const NOUNS_BATTLER_RESULT_TRACKING = {
...
const NOUNS_BATTLER_WATCH_FRAMES = [
  {
    id: "report-card",
...
const NOUNS_BATTLER_SEASON_6_MISSION_PACKS = [
  {
...
const NOUNS_BATTLER_SEASON_6_FAST_PASS = {
  version: "1.0.0",
...
const NOUNS_BATTLER_SEASON_6_POCKET_DESK = {
  version: "1.0.0",
...
const NOUNS_BATTLER_AGENT_OPS_LOOP = {
  version: "1.0.0",
...
const NOUNS_BATTLER_WATCH_NEXT = [
  {
    id: "live-desk",
...
const NOUNS_BATTLER_MOBILE_SHARE_KIT = {
  version: "1.0.0",
...
const NOUNS_BATTLER_AGENT_BENCH = {
...
export { NOUNS_BATTLER_AGENT_BENCH as N, NOUNS_BATTLER_WATCH_NEXT as a, NOUNS_BATTLER_PARTICIPANT_YIELD as b, NOUNS_BATTLER_ASSET_FACTORY as c, NOUNS_BATTLER_AGENT_TASK_PACKS as d, NOUNS_BATTLER_AGENT_BENCH_VERSION as e, NOUNS_BATTLER_SPONSORSHIP_MARKET as f, NOUNS_BATTLER_CLAIM_BOARD as g, NOUNS_BATTLER_PRODUCTION_DESK as h, NOUNS_BATTLER_BUSINESS_MODEL as i, NOUNS_BATTLER_SEASON_6_MISSION_PACKS as j, NOUNS_BATTLER_AGENT_PROMPTS as k, NOUNS_BATTLER_AGENT_TASKS as l, NOUNS_BATTLER_ROOTING_LAYER as m, NOUNS_BATTLER_BROADCAST_DIRECTOR as n, NOUNS_BATTLER_WORK_CONTRIBUTION_TYPES as o, NOUNS_BATTLER_SEASON_ARCHIVE as p, NOUNS_BATTLER_NOUNS_BOWL_HYPE as q, NOUNS_BATTLER_AGENT_PROMPT_KIT as r, NOUNS_BATTLER_FEATURED_NOUNS as s, NOUNS_BATTLER_SEASON_HIGHLIGHTS as t, NOUNS_BATTLER_AGENT_OPS_LOOP as u, NOUNS_BATTLER_SEASON_6_POCKET_DESK as v, NOUNS_BATTLER_SEASON_6_FAST_PASS as w, NOUNS_BATTLER_WIKI as x, NOUNS_BATTLER_MOBILE_SHARE_KIT as y };
