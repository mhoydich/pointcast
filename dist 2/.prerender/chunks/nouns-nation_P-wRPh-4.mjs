const payload = {
  ...
  routes: {
    ...
    battlerWiki: "https://pointcast.xyz/nouns-nation-battler-wiki/",
    battlerWikiJson: "https://pointcast.xyz/nouns-nation-battler-wiki.json",
