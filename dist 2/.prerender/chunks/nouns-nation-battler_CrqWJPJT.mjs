import { x as NOUNS_BATTLER_WIKI, b as NOUNS_BATTLER_PARTICIPANT_YIELD, i as NOUNS_BATTLER_BUSINESS_MODEL, q as NOUNS_BATTLER_NOUNS_BOWL_HYPE, p as NOUNS_BATTLER_SEASON_ARCHIVE, m as NOUNS_BATTLER_ROOTING_LAYER, n as NOUNS_BATTLER_BROADCAST_DIRECTOR, h as NOUNS_BATTLER_PRODUCTION_DESK, o as NOUNS_BATTLER_WORK_CONTRIBUTION_TYPES, g as NOUNS_BATTLER_CLAIM_BOARD, f as NOUNS_BATTLER_SPONSORSHIP_MARKET, c as NOUNS_BATTLER_ASSET_FACTORY, y as NOUNS_BATTLER_MOBILE_SHARE_KIT, a as NOUNS_BATTLER_WATCH_NEXT, j as NOUNS_BATTLER_SEASON_6_MISSION_PACKS, u as NOUNS_BATTLER_AGENT_OPS_LOOP, v as NOUNS_BATTLER_SEASON_6_POCKET_DESK, w as NOUNS_BATTLER_SEASON_6_FAST_PASS } from './nouns-battler-agent-bench_CoupaMI8.mjs';
...
const payload = {
  ...
  broadcastDesk: {
    ...
    resultReenactor: {
      ...
      goals: ["watch", "share", "agent", "sponsor"],
      ...
      missionOutputs: ["launch URL", "host rundown", "agent task", "share receipt", "proof checklist"],
      localSlate: ["NBA close", "WNBA comeback", "NFL overtime", "MLB blowout", "EPL upset"],
  ...
  game: {
    ...
    battleTypes: ["Open Field Clash", "Amplifier Rift", "Crown Rush", "Lava Audit", "Cloud Court", "Trash Planet", "Fog Bowl", "Nouns Kingdom"],
  ...
  featuredMode: {
    ...
    matchSize: "25 vs 25",
    beats: ["proposal wave", "auction tower volley", "meme lane flood", "Noun Gate pressure", "Nouns lane calls"],
  ...
  agentEconomy: {
    ...
    productionDeskModel: NOUNS_BATTLER_PRODUCTION_DESK,
    claimBoardModel: NOUNS_BATTLER_CLAIM_BOARD,
    acceptedWorkLedger: {
