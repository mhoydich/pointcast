...
const GARDEN_YIELD_CONTEXT = {
  name: "Garden value-yield system",
  url: "https://pointcast.xyz/garden-yield",
  jsonUrl: "https://pointcast.xyz/garden-yield.json",
  purpose: "Turn the El Segundo native planting palette from Block 0331 into an interactive site-fit, value-score, and establishment planner.",
...
export { GARDEN_YIELD_PLANTS as G, GARDEN_YIELD_SITES as a, GARDEN_YIELD_SOURCE_BLOCK as b, GARDEN_YIELD_METRICS as c, GARDEN_YIELD_CONTEXT as d, GARDEN_YIELD_LOOP as e };
