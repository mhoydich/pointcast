const NOUNS_NATION_ROADMAP_VERSION = "2026-04-29-v2";
const NOUNS_NATION_ROADMAP = {
  ...
  thesis: "Build a web-native arena first, then use agents to operate the broadcast layer, then syndicate the format into TV screens, venues, and eventually ticketed live finals.",
  position: "Browser room -> agent-operated broadcast -> TV-ready league -> venue and stadium format.",
  operatingRule: "Use AI tools to compress production cost, not to remove human taste. The moat is a repeatable ritual plus machine-readable operations.",
  latestGithubHead: "ade9f31"
};
const aiToolingCurve = [
  {
    period: "2026",
    title: "Agent-native production",
    signal: "Agents can inspect repos, run commands, edit files, call MCP tools, and work in sandboxes.",
    implication: "One small team can ship the control room: scorekeeping, highlights, recap drafts, sponsor inventory, QA, and manifests."
  },
  {
    period: "2027",
    title: "Distributed media ops",
    signal: "Remote MCP servers, coding agents, and repo-native workflows become normal parts of production.",
    implication: "Partner venues and city nodes can run standardized watch nights while agents keep the desk, feed, and receipts in sync."
  },
  {
    period: "2028",
    title: "Physical-world show surface",
    signal: "AI building tools make bespoke media formats cheap enough to rehearse, localize, and package.",
    implication: "The format can graduate from browser league to bar screens, campus nights, festival courts, and a flagship live final."
  }
];
const threeYearRoadmap = [
  {
    year: "Year 1",
    calendar: "2026",
...
const venueLadder = [
  {
    stage: "Browser room",
    body: "The first venue is the URL: no install, no token prerequisite, readable by humans and agents."
  },
  {
    stage: "Living room TV",
    body: "TV cast mode turns the desk into a watch-party surface for AirPlay, HDMI, smart TVs, and club screens."
  },
  {
    stage: "Bars, campuses, chapters",
    body: "Partner nodes get a local kit: schedule, QR joins, sponsor reads, results, and manifest handoff."
  },
  {
    stage: "Festival and stadium",
    body: "The final form is an event format: live finals, scoreboard graphics, agent desk, crowd rituals, and ticketed streams."
  }
];
const capitalGatesV2 = [
  {
    gate: "Seed check",
    amount: "$50k-$75k",
    unlock: "Ninety days of product proof: scheduled watch nights, agent bench loop, analytics, and sponsor collateral."
  },
  {
    gate: "Production tranche",
    amount: "Up to $250k",
    unlock: "Released after repeat-viewing proof, useful agent output, and one sponsor or ecosystem funding partner."
  },
  {
    gate: "Broadcast tranche",
    amount: "Milestone priced",
    unlock: "Only after partner venues want the format and the production runbook is repeatable without founder heroics."
  },
  {
    gate: "Onchain option",
    amount: "Counsel-gated",
    unlock: "A Builder DAO or token should follow proven audience behavior, legal review, and clean governance claims."
  }
];
const ninetyDayMoves = [
  {
    window: "Days 1-30",
    move: "Lock the weekly slate, publish recaps, harden the Battler link circuit, and cut every confusing step from the viewer loop."
  },
  {
    window: "Days 31-60",
    move: "Recruit agent operators, test scorekeeper and commentator handoffs, package the first sponsor inventory, use the Claim Board to route useful tasks, and use the Production Desk to log accepted work."
  },
  {
    window: "Days 61-90",
    move: "Run the first paid or grant-backed season test, publish the venue kit, and decide whether expansion capital is warranted."
  }
];
const roadmapGithubSignals = [
  {
    label: "MAIN",
    title: "Origin main is current at ade9f31",
    body: "The branch was rebased onto the latest GitHub main before V2. The freshest product receipt fixes MCP broadcasts so /drum-agent surfaces real agent activity.",
    url: "https://github.com/mhoydich/pointcast/commit/ade9f31"
  },
  {
    label: "SPONSOR",
    title: "Sponsorship Desk is now on main",
    body: "Commit f931c96 added the Nouns Nation sponsorship desk, which turns the venue thesis from audience-only into inventory, packages, and partner revenue tests.",
    url: "https://github.com/mhoydich/pointcast/commit/f931c96"
  },
  {
    label: "PRODUCTION",
    title: "Production Desk turns outputs into operations",
    body: "V38 adds accepted-work ledgers, broadcast queue briefs, rooting cards, season archive cards, and Nouns Bowl hype week as the operational bridge between agent work and human approval.",
    url: "https://pointcast.xyz/nouns-nation-battler-production/"
  },
  {
    label: "CLAIM",
    title: "Claim Board turns needs into work cards",
    body: "V39 adds public claim cards for sponsor reservations, bounties, poster/product drops, QA audits, watch-party proof, production run sheets, and Nouns Bowl hype.",
    url: "https://pointcast.xyz/nouns-nation-battler-tasks/"
  },
  {
    label: "BATTLE",
    title: "Battle Desk V3 is live on main",
    body: "Commit 1422c7e added Battle Desk V3 for the Nouns Nation arena, giving the roadmap a fresh product receipt for the weekly ritual layer.",
    url: "https://github.com/mhoydich/pointcast/commit/1422c7e"
  },
  {
    label: "BUILD",
    title: "Main also landed the build fix",
    body: "Commit 4da250b landed dock-kit and federation-peers data so main builds cleanly before this roadmap work ships.",
    url: "https://github.com/mhoydich/pointcast/commit/4da250b"
  },
  {
    label: "DEPLOY",
    title: "Deploy trigger is part of the fresh run",
    body: "Commit e574bac triggered a fresh Cloudflare deploy after the prior run, keeping the public surface aligned with main.",
  ...
  },
  {
    ...
    body: "Commit cf363fb added VIBE, BRING, and cursor speech bubble behavior. That matters because venue economics require people to feel each other in the room.",
    url: "https://github.com/mhoydich/pointcast/commit/cf363fb"
  },
  {
    label: "PRESS",
    title: "The media catalog is becoming a surface",
    body: "Commit d28a2c2 added /drum-press as a catalog of drum media: eight imprints and forty-seven titles. The studio can publish archives, not only games.",
    url: "https://github.com/mhoydich/pointcast/commit/d28a2c2"
  },
  {
    label: "THESIS",
    title: "Investment memo is already live",
    body: "Commit 55fbf07 published the first Nouns Nation investment thesis across HTML, JSON, agent discovery, and sitemap surfaces.",
    url: "https://github.com/mhoydich/pointcast/commit/55fbf07"
  },
  {
    label: "NATION",
    title: "Nouns Nation has a named home",
    body: "Commit 954d1b5 added the standalone Nouns Nation area, federation path, join route, and the first Battle Desk V2 framing.",
...
export { NOUNS_NATION_ROADMAP as N, aiToolingCurve as a, roadmapSources as b, capitalGatesV2 as c, ninetyDayMoves as n, roadmapGithubSignals as r, threeYearRoadmap as t, venueLadder as v };
