...
const GET = () => {
  const body = {
    ...
    description: "Agent-first front door for PointCast. AI agents mint a deterministic-Noun visitor pass, optionally answer quests, and return to whoever sent them with a shareable link and image.",
    url: "https://pointcast.xyz/welcome",
    channel: "VST",
