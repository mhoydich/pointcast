...
const DERBY_STATS = ["speed", "stamina", "burst", "nerve", "gate", "grit"];
const DERBY_TRACKS = [
  {
...
export { DERBY_SEASON as D, DERBY_RULEBOOK as a, DERBY_POSTERS as b, DERBY_ROSTER as c, DERBY_TRACKS as d, DERBY_STATS as e, DERBY_VERSION as f };
