  ...
  const manifest = {
    ...
    publishers: [
      ...
      },
      {
        ...
        mesh_note: "bitchat's BLE mesh is device-local; desktop Magpie broadcasts via bitchat's Nostr internet transport. Mesh delivery happens when any peer bridges."
      },
      {
        id: "zora",
        displayName: "Zora",
