const MORNING_OCEAN_STYLE_PROMPT = "Morning Ocean collectible NFT art series, quiet luxury maritime oil-painting cards, woven canvas texture, calm horizon, boats in the background, soft sun and planets, sophisticated palette, no text.";
const token = (tokenId, slug, title, vessel, celestial, horizon, mood, rarity, editionSize, palette) => ({
  tokenId,
  slug,
  title,
  vessel,
  ...
  palette,
  prompt: `${MORNING_OCEAN_STYLE_PROMPT} Token ${tokenId}: ${title}. Vessel: ${vessel}. Sky object: ${celestial}. Horizon: ${horizon}. Mood: ${mood}.`
});
const MORNING_OCEAN_TOKENS = [
...
export { MORNING_OCEAN_TOKENS as M, MORNING_OCEAN_STYLE_PROMPT as a };
