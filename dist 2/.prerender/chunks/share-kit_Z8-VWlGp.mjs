const SHARE_KIT_UPDATED = "2026-04-29";
const SHARE_PLAN_PATH = "docs/plans/2026-04-21-organic-visitors.md";
const SHARE_SPRINT_PATH = "docs/sprints/2026-04-21-organic-growth-share-board.md";
const SHOW_HN_PATH = "docs/outreach/2026-04-22-show-hn.md";
const SHARE_LANDING_PAGES = [
  {
    key: "start",
    title: "Start here",
    path: "/start",
...
const SHARE_SNIPPETS = [
  {
    key: "general",
    label: "General launch note",
    target: "/start",
    text: "PointCast is a living broadcast from El Segundo: blocks, games, Tezos experiments, agent-readable feeds, and a live presence layer.\n\nStart here: https://pointcast.xyz/start"
  },
  {
    key: "agents",
    label: "AI builders",
    target: "/agent-value",
    text: 'If you build with agents: the useful question is not "how smart is the model?" It is "what loop can this agent finish?" PointCast now has an Agent Value Board: roles, receipts, economics, and experiments.\n\nhttps://pointcast.xyz/agent-value'
  },
  {
    key: "nouns",
    label: "Nouns / Tezos",
    target: "/collection/visit-nouns",
    text: "PointCast has Visit Nouns live on Tezos: FA2 contract, objkt collection, TzKT-backed gallery, CC0 noun seeds, and the next primitive is a daily auction loop.\n\nhttps://pointcast.xyz/collection/visit-nouns"
  },
  {
    key: "local",
    label: "Local",
    target: "/local",
    text: "PointCast is an El Segundo broadcast with a 100-mile lens: stations, local blocks, and place as a real interface layer.\n\nhttps://pointcast.xyz/local"
  },
  {
    key: "play",
    label: "Play first",
    target: "/battle",
    text: "Try Nouns Battler: every Nouns seed is a deterministic fighter. Same seed, same stats forever. Card of the Day rotates daily.\n\nhttps://pointcast.xyz/battle"
  },
  {
    key: "tools",
    label: "AI stack",
    target: "/ai-stack",
    text: "We wrote down the AI stack PointCast actually uses: daily tools, weekly tools, experimental tools, what each is good at, and what to avoid.\n\nhttps://pointcast.xyz/ai-stack"
  }
];
const SHARE_LAUNCH_ASSETS = [
  {
    key: "show-hn",
    title: "Show HN draft",
    kind: "copy deck",
    ...
    primaryCopy: "Show HN: A static reader that federates reading lists over Nostr"
  },
  {
    key: "outreach-list",
    ...
    primaryCopy: "Specific observation + one question + one link. No generic launch copy."
  }
];
const SHARE_CAMPAIGN_PACKETS = [
  {
    key: "recrawl",
...
export { DISTRIBUTION_LOOP as D, SHARE_LANDING_PAGES as S, SHARE_SNIPPETS as a, SHARE_LAUNCH_ASSETS as b, SHARE_CAMPAIGN_PACKETS as c, SHARE_KIT_UPDATED as d, SHARE_AUDIENCES as e, SHARE_ACTION_CHECKLIST as f, SHARE_PLAN_PATH as g, SHARE_SPRINT_PATH as h };
