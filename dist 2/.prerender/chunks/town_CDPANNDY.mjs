...
const GET = async () => {
  const payload = {
    ...
    name: "PointCast · /town",
    version: "0.1.0",
    description: "Pixel-art isometric map of PointCast. Every building is a real PointCast surface; every visitor is a Noun-head sprite walking between them. Drum Hall pulses on live drum activity.",
