...
- [ ] (X) Generate and verify the 31 plates at 1024×1280 through poster-image-engine, save PNG + WebP twins, flip `image.status` to `verified`, write the Codex log — `handoff`
