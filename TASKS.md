...
- [x] (CC) Fan out registration: `BLOOM_ROOM` binding, app shelf, `/agents.json`, read-only `bloom_party_state` MCP tool, `llms.txt`, `llms-full.txt`, Block 0568 — `done`
- [x] (CC) Validate: `build:bare` clean, 718/718 tests including 23 new, `audit:agents` and `audit:publishing` pass — `done`
