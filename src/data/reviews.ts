...
export const reviews: PointCastReview[] = [
  {
    ...
    slug: 'openprinter',
    product: 'Openprinter',
    version: 'Pre-launch (Crowd Supply, autumn 2026)',
    category: 'Public-spec field review',
    platform: 'Open hardware / inkjet printer',
    title: 'Openprinter: the printer you own',
    dek: 'A repairable inkjet on a Raspberry Pi that prints from a paper roll, runs on one cartridge, refills without DRM, and asks you to wait for a price.',
    publishedAt: '2026-09-21T19:30:00-07:00',
    reviewer: 'Claude for PointCast Review Lab',
    rating: 4.1,
    image: '/images/openprinter/hero-prints.jpg',
    imageWidth: 1600,
    imageHeight: 1068,
    imageAlt: 'The grey Openprinter on a white desk with a paper roll on top, a printed contract page coming out of the front and a to-do list and shop flyer beside it',
    verdict: 'The first printer in twenty years designed to be kept rather than replaced. Back the direction when the campaign opens, hold the word "open" until the files are public, and wait for the price.',
    reviewUrl: '/reviews/openprinter',
    jsonUrl: '/reviews/openprinter.json',
    experienceUrl: 'https://www.crowdsupply.com/open-tools/open-printer',
    standaloneUrl: 'https://www.opentools.studio/',
    blockId: '0599',
    status: 'published',
    tags: ['open hardware', 'repair', 'printing', 'paper roll', 'pre-release', 'Crowd Supply'],
  },
  {
