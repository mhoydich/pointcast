...
export const AGENT_SURFACES = {
  human: {
    ...
    charts: 'https://pointcast.xyz/charts',
  ...
  json: {
    ...
    connect: 'https://pointcast.xyz/connect.json',
    station: 'https://pointcast.xyz/station.json',
    charts: 'https://pointcast.xyz/charts.json',
    ...
    agentCabinet: 'https://pointcast.xyz/x402/collect.json',
  ...
  api: {
    ...
    agentCabinetChallenge: 'https://pointcast.xyz/api/agent-cabinet/challenge',
    agentCabinetCollect: 'https://pointcast.xyz/api/agent-cabinet/collect',
