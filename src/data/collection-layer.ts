import { MORNING_OCEAN_TOKENS } from './morning-ocean';
import { ZEN_CAT_GENESIS_COLLECTIBLES, ZEN_CAT_WORLD_COLLECTIBLES } from './zen-cat-collectibles';
...
export const CURATOR_THEMES: readonly CuratorTheme[] = [
...
export const RITUAL_SLOTS: readonly RitualSlot[] = [
  {
    id: 'dawn',
    label: 'Dawn Cat',
    hour: '06:30',
...
export const EXCHANGE_LANES: readonly ExchangeLane[] = [
...
export const ATLAS_STOPS: readonly AtlasStop[] = ZEN_CAT_WORLD_COLLECTIBLES.slice(0, 30).map((item, index) => {
