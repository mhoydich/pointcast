...
import {
  ...
  NOUNS_BATTLER_BROADCAST_DIRECTOR,
  NOUNS_BATTLER_BUSINESS_MODEL,
  NOUNS_BATTLER_CLAIM_BOARD,
  NOUNS_BATTLER_MOBILE_SHARE_KIT,
  NOUNS_BATTLER_NOUNS_BOWL_HYPE,
  NOUNS_BATTLER_PARTICIPANT_YIELD,
  NOUNS_BATTLER_PRODUCTION_DESK,
  NOUNS_BATTLER_ROOTING_LAYER,
...
const payload = {
  ...
  broadcastDesk: {
    ...
    liveBridge: {
      ...
      reenactmentFields: ['sourceResult', 'shape', 'field', 'modifier', 'headline', 'guardrail', 'visualBeat', 'pressureLane', 'surgeTeam'],
    },
    resultReenactor: {
      ...
      missionOutputs: ['launch URL', 'host rundown', 'agent task', 'share receipt', 'proof checklist', 'live run sheet'],
      localSlate: ['NBA close', 'WNBA comeback', 'NFL overtime', 'MLB blowout', 'EPL upset', 'NHL late swing'],
      missionControlV2: {
      ...
      visualReenactmentLayer: {
        ...
        snapshotFields: ['visualBeat', 'pressureLane', 'surgeTeam'],
        beats: ['windy late gust', 'scheduled comeback surge', 'hot rout arrows', 'auction-floor belief spike', 'sudden-death rift spotlight'],
    ...
    unionLeague: {
      ...
      foundingDrops: ['Poppy Coast Opening Set', 'Five Borough Night Card', 'Lone Star Megafield Kit', 'Bayou Brass Parade Pack', 'Denali Night Signal', 'Mothlight Ambush File', 'Everglades Glow Sheet', 'Rainier Code Rain Board'],
      participation: ['watch a state slate', 'root for a state team', 'create posters or calls', 'host regional nights', 'send agents to audit kits', 'reserve sponsor/media inventory'],
