...
const payload = {
  ...
  status: 'playable browser prototype v41 federation sprint room pocket desk, fast pass, sponsorship desk, production desk, public claim board, agent sideline desk, and asset factory',
