...
const payload = {
  ...
  status: 'playable browser prototype v13 season challenges',
  ...
  intent: 'A watchable Nouns auto-battler where numbered Nouns players and eight rotating gangs play a two-week 30 vs 30 league into a Nouns Bowl final, with scout cards, sim controls, rotating season challenges, Director Mode TV, Noun-heavy overview interstitials, Amplifier Rift, Crown Rush, weird terrain battle types, a 20-poster type-heavy Nouns series, and recaps.',
  game: {
    genre: 'auto battler',
    matchSize: '30 vs 30',
    mode: 'fully automated two-week league watch mode with Open Field, Amplifier Rift, Crown Rush, Lava Audit, Cloud Court, Trash Planet, and Fog Bowl battle types plus fullscreen Director Mode TV cast, overview interstitials, and rotating season challenge objectives',
    controls: ['next match', 'quick sim', 'sim day', 'pause/resume', 'auto-next', 'reset league', 'slow/live/rush speed', 'root left', 'root right', 'click Noun to scout', 'TV keyboard: space pause', 'TV keyboard: N next match', 'TV keyboard: Q quick sim', 'TV keyboard: D sim day', 'TV keyboard: I replay interstitial', 'TV keyboard: R reset league'],
    league: {
      teams: 8,
  ...
  links: {
    ...
    lavaAudit: 'https://pointcast.xyz/games/nouns-nation-battler/index.html?mode=tv&type=lava',
    cloudCourt: 'https://pointcast.xyz/games/nouns-nation-battler/index.html?mode=tv&type=cloud',
    trashPlanet: 'https://pointcast.xyz/games/nouns-nation-battler/index.html?mode=tv&type=trash',
    fogBowl: 'https://pointcast.xyz/games/nouns-nation-battler/index.html?mode=tv&type=fog',
