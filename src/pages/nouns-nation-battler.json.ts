...
const payload = {
  ...
  status: 'playable browser prototype v39 federation sprint room, sponsorship desk, production desk, public claim board, agent sideline desk, and asset factory',
