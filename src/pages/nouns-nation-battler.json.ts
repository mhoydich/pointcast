...
const payload = {
  ...
  broadcastDesk: {
    ...
    human: 'https://pointcast.xyz/nouns-nation-battler/',
    format: 'sports-desk style live hub with scorebug, league standings, top Nouns, root line, match queue, live calls, TV cast, desk wall, poster links, and embedded v30 field feed',
