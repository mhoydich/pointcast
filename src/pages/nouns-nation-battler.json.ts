...
const payload = {
  ...
  status: 'playable browser prototype v19 boss fields and rivalry heat',
  ...
  intent: 'A watchable Nouns auto-battler where numbered Nouns players and eight rotating gangs play a two-week 30 vs 30 league into a Nouns Bowl final, with rivalry heat, head-to-head records, late-season boss field mutations, a rookie Watch Guide, live storyline engine, Watch Party Kit, Recap Studio, Season 2 scope board, scout cards, sim controls, rotating season challenges, Director Mode TV, Noun-heavy overview interstitials, Amplifier Rift, Crown Rush, weird terrain battle types, a 20-poster type-heavy Nouns series, GTM strategy, and recaps.',
  game: {
    genre: 'auto battler',
    matchSize: '30 vs 30',
    mode: 'fully automated two-week league watch mode with Open Field, Amplifier Rift, Crown Rush, Lava Audit, Cloud Court, Trash Planet, and Fog Bowl battle types, late-season boss fields, fullscreen Director Mode TV cast, overview interstitials, and rotating season challenge objectives',
    controls: ['next match', 'quick sim', 'sim day', 'pause/resume', 'auto-next', 'reset league', 'watch guide', 'copy invite', 'copy storyline', 'copy recap', 'copy next hook', 'copy TV link', 'copy guide link', 'copy poster link', 'force boss field by URL', 'disable boss field by URL', 'slow/live/rush speed', 'root left', 'root right', 'click Noun to scout', 'rivalry badge', 'TV keyboard: space pause', 'TV keyboard: N next match', 'TV keyboard: Q quick sim', 'TV keyboard: D sim day', 'TV keyboard: I replay interstitial', 'TV keyboard: G watch guide', 'TV keyboard: R reset league'],
    league: {
      teams: 8,
