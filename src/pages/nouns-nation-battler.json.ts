...
const payload = {
  ...
  status: 'playable browser prototype v40 federation sprint room fast pass, sponsorship desk, production desk, public claim board, agent sideline desk, and asset factory',
