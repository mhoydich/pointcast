...
const payload = {
  ...
  status: 'playable browser prototype v38 federation sprint room, sponsorship desk, production desk, agent sideline desk, and asset factory',
