...
export const GET: APIRoute = () =>
  new Response(
    JSON.stringify(
      {
        $schema: 'https://pointcast.xyz/scoreboard.json#schema',
        type: 'pointcast-scoreboard-v1',
        generatedAt: board.generatedAt,
        human: 'https://pointcast.xyz/scoreboard',
        method: {
          ...
          score: 'with a counter 45/27.5/27.5, without 50/50 craft/reach',
        ...
        rows: board.rows.map((r) => ({
          ...
          use: r.use, craft: r.craft, reach: r.reach, loc: r.loc, files: r.files, tests: r.tests, inbound: r.inbound, blocks: r.blockRefs, onHome: r.onHome,
        })).map((r, i) => ({ ...r, rank: i + 1 })),
      },
      null,
      2,
