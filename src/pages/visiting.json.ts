/**
 * /visiting.json — agent-readable mirror of the visitors' handbook.
 *
 * Returns the same structured info /visiting renders, in JSON. An agent
 * arriving at PointCast can fetch this single URL to learn what the
 * site is, where the rooms are, and how to leave a mark — without
 * parsing HTML.
 */
