...
import { ART_KITTY_CAMPAIGN, DRUM_COMPENDIUM_CAMPAIGN, DRUM_NOUN_UNIVERSE_CAMPAIGN, HOLDERS_CUT_CAMPAIGN, INDUSTRY_NEXT_CAMPAIGN, NETWORK_EL_SEGUNDO_CAMPAIGN, NETWORK_FIRST_100_SIGNAL, NOUNS_ABOUT_CAMPAIGN, OPEN_AD_NETWORK, OPEN_AD_PLACEMENT, OPEN_AD_PUBLISHERS, PERMISSION_LAB_CAMPAIGN, POINTCAST_ADS } from '../lib/open-ad-network';
...
export const GET: APIRoute = () => {
  const payload = {
    ...
    houseSeries: [NETWORK_EL_SEGUNDO_CAMPAIGN, ART_KITTY_CAMPAIGN, HOLDERS_CUT_CAMPAIGN, INDUSTRY_NEXT_CAMPAIGN, NOUNS_ABOUT_CAMPAIGN, PERMISSION_LAB_CAMPAIGN, DRUM_NOUN_UNIVERSE_CAMPAIGN, DRUM_COMPENDIUM_CAMPAIGN],
