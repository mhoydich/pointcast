...
const payload = {
  ...
  latestVersion: {
    ...
    thought:
      'Make the sport watchable, make receipts portable, give the league memory through champions and MVPs, and turn the next sprint into an expansion/media/rights room for outside nations.',
