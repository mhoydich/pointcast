...
import { ABSTRACT, PAPER_META, PAPER_NOTES, PLATES, REFERENCES, SECTIONS } from '../lib/bellLabsPaper';

export const GET: APIRoute = async () => {
  const payload = {
    $schema: 'https://pointcast.xyz/bell-labs.json',
    ...
    human: 'https://pointcast.xyz/bell-labs',
    parent: 'https://pointcast.xyz/labs',
    related: {
      seriesHub: 'https://pointcast.xyz/labs',
      menloPark: 'https://pointcast.xyz/menlo-park',
