  ...
  const payload = {
    ...
    endpoints: {
      ...
      human: {
        ...
        bloomParty: 'https://pointcast.xyz/bloom-party',
        bloomPartyJson: 'https://pointcast.xyz/bloom-party.json',
        bloomPartySocket: 'wss://pointcast.xyz/api/bloom/room?room={CODE}&sid={client-uuid}&role=player',
        bloomPartyStats: 'https://pointcast.xyz/api/bloom/room?room={CODE}&stats=1',
