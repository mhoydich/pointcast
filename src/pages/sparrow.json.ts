    ...
    nostr: {
      ...
      federated_lists: {
        ...
        digest_sidecar: {
          ...
          cron_worker: {
            since: 'v0.33',
            status: 'v0.34 · signing module live (workers/sparrow-digest/src/signing.ts); email template wires signed unsub URL; cron dispatch + signals aggregation still pending',
            location: 'workers/sparrow-digest/ (wrangler.toml + src/index.ts + src/signing.ts + README.md)',
            ...
            not_yet: 'nostr client port from sparrow-app · signals aggregation logic mirror · block-lookup prefetch · retry with jitter',
          },
