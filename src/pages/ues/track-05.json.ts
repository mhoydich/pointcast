/**
 * /ues/track-05.json — agent-readable mirror of UES Track 05.
 *
 * Same content as the .astro page, shaped as JSON. Agents looking for
 * the syllabus shouldn't have to parse HTML.
 */
  ...
  lessons: [
    {
      ...
      reading: 'BLOCKS.md',
      thesis:
        "An address that won't be reassigned is a promise. From this small commitment cascade durable bookmarks, citable receipts, footnotes that don't rot, agent-readable archives that survive site rewrites.",
    ...
    },
    {
      ...
      thesis:
        'A button is a transaction. A spell is a summoning — a word, a small shimmer, an effect that lingers. What changes about an interface when its primary verb is conjure rather than submit?',
    ...
    },
    {
      ...
      thesis:
        'The town has guests who arrive without warning — sometimes a curious browser, sometimes an AI agent. The site is built to meet them with a handbook, a manifest, and a ledger of bilateral receipts. The etiquette layer of an inhabitable internet.',
    ...
    },
    {
      ...
      thesis:
        "PointCast runs an hourly cron. The maker is a script that does not eat. What is work, when production is cheap and patient in a way humans never are?",
    ...
    },
    {
      ...
      thesis:
        'Maintenance is the posture from which new work becomes possible. A repo whose backlog is on fire cannot host a 33rd spell. Sunday morning is the work.',
    ...
    },
    {
      ...
      thesis:
        "The site's stated aesthetic is geocities + sim city, not clean AI product. The choice is political. When is heterogeneity a feature? When does an aesthetic become a kind of public-domain commons?",
      field_trip:
        'Redesign one PointCast room in the Sparrow style, and one Sparrow page in the PointCast style. Notice what each loses.',
...
export const GET: APIRoute = () =>
  new Response(JSON.stringify(TRACK_05, null, 2), {
    headers: {
