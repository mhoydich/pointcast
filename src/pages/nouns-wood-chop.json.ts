...
const payload = {
  ...
  intent: 'A pixel collect loop for PointCast where visitors choose a Noun helper, chop, collect wood, trigger streak rewards, bank bundles, plant seeds, and unlock local Nouns-themed stamps.',
