...
export const POINTCAST_ADS: PointCastAd[] = [
  ...
  },
  {
    ...
    advertiser: 'Network El Segundo',
    headline: 'Every wallet turns on one light.',
    copy: 'Enter the living First 100 Signal with one free Kukai message signature. Zero tez, no purchase, no mint, and no transaction.',
  ...
  },
  {
    ...
    advertiser: 'Network El Segundo',
    headline: 'One hundred positions. One live signal.',
    copy: 'Verify one Tezos wallet to illuminate one public position. The signature proves wallet control only; addresses stay out of the artwork.',
    href: '/network-el-segundo',
    cta: 'Enter the signal free',
    tone: 'garden',
  ...
  },
  {
    ...
    advertiser: 'Network El Segundo',
    headline: 'Transmit the First 100 Signal.',
    copy: 'Join with a free Kukai signature, turn on one light, then pass the clean link to one Tezos person.',
    href: '/network-el-segundo',
    cta: 'Transmit the signal',
    tone: 'play',
