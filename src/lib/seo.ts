...
export const DISCOVERY_LINKS: DiscoveryLink[] = [
  ...
  { rel: 'alternate', type: 'application/json', href: '/.well-known/agents.json', title: 'PointCast well-known agent manifest' },
  { rel: 'alternate', type: 'application/json', href: '/.well-known/ai.json', title: 'PointCast well-known AI manifest' },
