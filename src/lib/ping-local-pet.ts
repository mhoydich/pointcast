export const PING_LOCAL_PET = {
  schema: 'pointcast.ping-local-pet/v1',
  ...
  notYetProof: [
    'No production cryptography or reviewed device key-storage implementation.',
    'No ESP32-S3 / RAK3172 hardware port, drivers, or encrypted flash binding.',
  ...
  buildSequence: [
    ...
    },
    {
      gate: 'G1',
      title: 'Make 10 + 2',
      proof: 'Port the host core, integrate two radios, assemble Alpha pets, and publish defects as well as demos.',
      status: 'blocked',
    },
    {
      gate: 'G2',
