export const PING_LOCAL_PET = {
  schema: 'pointcast.ping-local-pet/v2',
  ...
  updatedAt: '2026-07-30T12:02:38-07:00',
  ...
  truth: {
    ...
    protocolVersion: 2,
    wireEnvelopeBytes: 84,
    wireAcknowledgementBytes: 47,
    hostSecurityTestDouble: true,
    esp32CompileTargetPassed: true,
    esp32SourceCommit: 'f91b1abf1974945276b43e03309a234ca160bfd0',
    espIdfVersion: '6.0.1',
    esp32ReportedFlashBytes: 322401,
    esp32ReportedRamBytes: 16108,
  ...
  currentProof: [
    {
      ...
      value: '26 / 26',
      detail:
        'Normal and sanitizer host tests pass across compose, route, retry, expiry, acknowledgement, replay, relay, and recovery behavior.',
    },
    {
      label: 'ESP32-S3 target',
      value: 'LINKED',
      detail:
        'Two clean ESP-IDF 6.0.1 builds produced matching app, bootloader, and partition hashes. No board was flashed.',
    },
    {
      label: 'Relay boundary',
      value: '84 bytes',
      detail:
        'The transport-facing wire envelope carries opaque ciphertext rather than a plaintext signal code.',
    },
    {
  ...
  notYetProof: [
    'The PSA AES-256-GCM/HMAC adapter compiles, but origin identity, per-hop integrity, secure-element storage, and independent review remain open.',
  ...
  alpha: {
    ...
    blockers: [
      'The exact ESP32-S3-DevKitC-1-N8R8 showed zero visible Mouser stock in the dated public snapshot.',
      'The selected 2.13-inch e-paper display showed nine units—three short of the twelve-unit Alpha requirement.',
