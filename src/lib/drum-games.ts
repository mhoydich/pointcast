...
export const DRUM_GAMES: readonly DrumGame[] = [
  ...
  },
  {
    ...
    description: 'A Noun runs an El Segundo strip while obstacles arrive on the beat. Jump clean, keep flow, go farther.',
    skill: 'Anticipation',
    controls: 'Tap stage · Space',
    nounId: 214,
    accent: '#7ac8ed',
    bestKey: 'pc-drum-runner-best',
    bestUnit: ' meters',
    bestDirection: 'high',
  },
  {
