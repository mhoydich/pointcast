export const POINTCAST_PETS_VERSION = '0.2.0';

export const POINTCAST_PETS_DESCRIPTION =
  'PointCast Pets is the plan for local-first site companions: the current site pet, its live name poll and care loop, Zen Cats, future room pets, passport care receipts, and Tezos-ready collectible paths.';

export const POINTCAST_SITE_PET_STORAGE_KEYS = {
  care: 'pc:pet:care',
  passportStamps: 'pc:passport:stamps',
  nameVote: 'pc:poll:voted:site-pet-name',
} as const;

export const POINTCAST_SITE_PET_MOOD_LADDER = [
  {
    id: 'sleepy',
    label: 'sleepy signal',
    min: 0,
...
export const POINTCAST_SITE_PET_NAME_OPTIONS = [
  {
    id: 'beacon',
    label: 'Beacon',
...
export const POINTCAST_SITE_PET_NAME_POLL = {
  slug: 'site-pet-name',
  ...
  outcome:
    'The leading name can become the public pet label after review; local care history stays private.',
} as const;

export const POINTCAST_PETS_SURFACES = [
  {
    id: 'pet',
    title: 'PointCast Pet',
    href: '/pet',
...
export const POINTCAST_PETS_ROSTER = [
  {
    id: 'site-pet',
    name: 'The Site Pet',
...
export const POINTCAST_PETS_PHASES = [
  {
    id: 'phase-0',
    label: 'Now',
    status: 'done',
...
export const POINTCAST_PETS_DECISIONS = [
  {
    id: 'site-pet-name',
    owner: 'MH',
    status: 'polling',
...
export const POINTCAST_PETS_QUEUE = [
  {
    id: 'pets-index',
    priority: 'P0',
    owner: 'X',
...
export function buildPointcastPetsManifest() {
  return {
    ...
    storagePolicy: {
      ...
      publicAgentRule:
        'Agents may cite rules, routes, and storage keys. Agents must not infer a visitor has a pet, stamp, or care history unless the visitor supplies local state.',
    },
  };
}
