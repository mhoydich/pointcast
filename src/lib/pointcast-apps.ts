...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    kicker: '10 EDITORIAL DESKS · 50 COACHES · 35 PROGRAMS · ONE LIVING SEASON',
    description: 'The magazine front door for the belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, season ledger, House Desk, Sound Desk, and Coaches Desk.',
