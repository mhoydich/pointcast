...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    kicker: '15 EDITORIAL DESKS · 8 KIFFIN READINGS · 12 PRESSURE FRONTS · 50 COACHES',
    description: 'The magazine front door for the Lane Kiffin Temperature Check, Coach Weather, the belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, season ledger, House Desk, Sound Desk, and Coaches Desk.',
