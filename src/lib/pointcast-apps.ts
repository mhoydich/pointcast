...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    description: 'A PointCast publication about what work does to a life and what a life does back: Uniforms, a consent-first work board, and Another Manic Monday.',
  ...
  },
  {
    ...
    kicker: '20 EDITORIAL DESKS · TEXAS ARCHIVE · GEORGIA GROUND ZERO · 50 COACHES',
    description: 'The magazine front door for Georgia, Ground Zero, the California State Report, Lane Kiffin Temperature Check, Coach Weather, belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, season ledger, House Desk, Sound Desk, and Coaches Desk.',
  ...
  {
    slug: 'texas-football-history-2026',
    name: 'The History of Texas Football',
    kicker: '10 OBJECTS · 134 SEASONS · 18 OFFICIAL + ARCHIVAL SOURCES',
    description: 'A PointCast Archive Desk history of Texas football through the objects that made it: student club, color vote, Bevo, Memorial Stadium, University Lands, the wishbone, integration, two Heisman eras, a contested song, fourth-and-five, and the unfinished 2026 SEC season.',
    url: 'https://pointcast.xyz/25/magazine/texas-football-history',
    path: '/25/magazine/texas-football-history',
    repo: 'https://github.com/mhoydich/pointcast',
    channel: 'CH.SPN',
    kind: 'pointcast',
  },
  ...
  },
  {
    ...
    description: 'A reported PointCast field essay on Georgia as college football’s most complete operating system—and the players, students, workers, town, state, and rituals that keep Saturday human.',
    url: 'https://pointcast.xyz/25/magazine/georgia-ground-zero',
    path: '/25/magazine/georgia-ground-zero',
    repo: 'https://github.com/mhoydich/pointcast',
    channel: 'CH.SPN',
    kind: 'pointcast',
  },
  {
    slug: 'california-football-2026',
    name: 'California Football Is Not Dead',
    kicker: '8 FBS PROGRAMS · 5 CONFERENCES · 7 IN-STATE GAMES · 5 COMPACT PROMISES',
  ...
  },
  {
    ...
    description: 'A timestamped preseason LSU merger audit across program, players, capital, Louisiana, staff, press, foes, and fans, closing with a clearly labeled PointCast synthesis of Paul Finebaum’s public position.',
    url: 'https://pointcast.xyz/25/magazine/lane-kiffin-temperature',
    path: '/25/magazine/lane-kiffin-temperature',
    repo: 'https://github.com/mhoydich/pointcast',
    channel: 'CH.SPN',
    kind: 'pointcast',
  },
  {
    slug: 'coaches-room-2026',
    name: "The Coaches' Room",
    kicker: 'THE POINTCAST 50 · SEVEN ROOM SCORES · 13-SONG COMPANION',
    description: 'A timestamped 2026 ranking of 50 current FBS head coaches through program, capital, players, region, fans, facilities, aura, and the next question capable of moving each coach.',
    url: 'https://pointcast.xyz/25/magazine/coaches-50',
    path: '/25/magazine/coaches-50',
    repo: 'https://github.com/mhoydich/pointcast',
    channel: 'CH.SPN',
    kind: 'pointcast',
  },
  {
    slug: 'coach-weather-2026',
    name: 'Coach Weather',
    kicker: '12 PRESSURE FRONTS · 50-COACH MATCHER · FOUR WEEKLY RETURNS',
    description: 'A recurring college-football pressure desk with an honest preseason baseline, twelve named rooms, local watchlists, and a 100-point Build Your Program matcher across the PointCast 50.',
    url: 'https://pointcast.xyz/25/magazine/coach-weather',
    path: '/25/magazine/coach-weather',
    repo: 'https://github.com/mhoydich/pointcast',
    channel: 'CH.SPN',
    kind: 'pointcast',
  },
