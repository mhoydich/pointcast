...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    kicker: '7 EDITORIAL DESKS · 35 PROGRAMS · ONE LIVING SEASON',
    description: 'The magazine front door for the belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, and append-only season ledger.',
