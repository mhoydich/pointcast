...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    kicker: '11 EDITORIAL DESKS · 12 PRESSURE FRONTS · 50 COACHES · ONE LIVING SEASON',
    description: 'The magazine front door for Coach Weather, the belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, season ledger, House Desk, Sound Desk, and Coaches Desk.',
