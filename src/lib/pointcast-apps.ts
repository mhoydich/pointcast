...
export const POINTCAST_APPS: PointcastApp[] = [
  ...
  },
  {
    ...
    kicker: '16 EDITORIAL DESKS · 8 CALIFORNIA PROGRAMS · 12 PRESSURE FRONTS · 50 COACHES',
    description: 'The magazine front door for the California State Report, Lane Kiffin Temperature Check, Coach Weather, belief board, receipt book, Song Yard, mascot desk, 2029 future school, Saturday Commons, season ledger, House Desk, Sound Desk, and Coaches Desk.',
