/**
 * Menlo Park — UES Working Paper 2026-06.
 * First entry in "The Lab and the Radius" series.
 */
...
export const SECTIONS: PaperSection[] = [
  {
    ...
    footnotes: [
      { mark: '1', text: 'Property records, Middlesex County, New Jersey. The original purchase was completed February 1, 1876.' },
      { mark: '2', text: 'Patent counts are approximate; the historical literature varies between 380 and 425 depending on counting methodology. See Israel (1998) for the canonical analysis.' },
    ],
  },
  {
    number: '2',
    ...
    footnotes: [
      { mark: '3', text: 'Edison Papers, Document 110:432. The "round-the-clock" point is from Edison\'s own correspondence with William Orton at Western Union; the lab famously kept hours that were impossible in any urban setting.' },
      { mark: '4', text: 'The October 21, 1879 photograph is reproduced in Israel (1998), figure 7.3.' },
    ],
  },
  {
    number: '3',
    ...
    footnotes: [
      { mark: '5', text: 'For a full biographical treatment of the principal Menlo Park collaborators, see Carlat (2004) and the Edison Papers Project online finding aid.' },
    ],
  },
  {
    number: '4',
    ...
    footnotes: [
      { mark: '6', text: 'Edison Papers Project, Rutgers University. http://edison.rutgers.edu. The notebook archive is approximately five linear miles of manuscript material.' },
    ],
  },
  {
    number: '5',
    ...
    footnotes: [
      { mark: '7', text: 'The earliest written form appears in Edison\'s 1877 correspondence with Theodore Puskás. The phrase has been variously rendered as "a minor invention every ten days" or "a small thing every ten days."' },
    ],
  },
  {
    number: '6',
    ...
    footnotes: [
      { mark: '8', text: 'Greenfield Village reconstruction completed 1929. The reconstruction is debated for its accuracy; see Casson (2010) for a careful treatment of which structures are originals vs. period reproductions.' },
    ],
  },
  {
    number: '7',
...
export const REFERENCES: Reference[] = [
  { id: 'edison-papers', cite: 'Edison Papers Project. (Ongoing). *The Papers of Thomas A. Edison*. Rutgers University. http://edison.rutgers.edu' },
  { id: 'israel-1998', cite: 'Israel, P. (1998). *Edison: A Life of Invention*. John Wiley & Sons.' },
  { id: 'carlat-2004', cite: 'Carlat, L. (2004). "Menlo Park\'s Industrial Research Laboratory and the Reconstruction of Inventive Practice." *Technology and Culture*, 45(3), 471–502.' },
  { id: 'casson-2010', cite: 'Casson, M. (2010). *Greenfield Village and the Edison Reconstruction*. Wayne State University Press.' },
  { id: 'edison-letters', cite: 'Edison, T. A. (1877–1886). *Selected Correspondence*. Edison Papers Project, Rutgers University.' },
  { id: 'baldwin-2001', cite: 'Baldwin, N. (2001). *Edison: Inventing the Century*. University of Chicago Press.' },
  { id: 'mocking-2018', cite: 'Mocking, R. (2018). "The Mucker Identity at Menlo Park." *Journal of the History of American Industry*, 12(2), 88–117.' },
  ...
  { id: 'pointcast-trapper', cite: 'University of El Segundo. (2026). *Velcro and Memory: A Material History of the Mead Trapper Keeper*. UES-WP-2026-04. https://pointcast.xyz/trapper-keeper' },
  { id: 'pointcast-walkman', cite: 'University of El Segundo. (2026). *Pocket Sound: A Material History of the Sony Walkman*. UES-WP-2026-05. https://pointcast.xyz/walkman' },
  { id: 'pointcast-labs', cite: 'University of El Segundo. (2026). *The Lab and the Radius* [series hub]. https://pointcast.xyz/labs' },
];

export type SpecimenPlate = { id: string; figure: string; caption: string; description: string; era: 'campus-1880' | 'notebook' | 'team-1879' | 'cadence-chart' };

export const PLATES: SpecimenPlate[] = [
  { id:'plate-i', figure:'Plate I', caption:'Menlo Park campus footprint, c. 1880. Six buildings on approximately six acres of fenced grounds. Reconstruction from Edison Papers archival photographs and surveyor\'s plats. The Pennsylvania Railroad mainline runs along the southern edge of the property.', description:'Schematic plan view of the Menlo Park lab complex.', era:'campus-1880' },
  { id:'plate-ii', figure:'Plate II', caption:'Menlo Park notebook page, c. 1879. Reconstruction of a typical experimental log entry — sketch, dated text, and dual signatures (Edison/Batchelor). The notebook architecture was the lab\'s memory.', description:'A page from a Menlo Park research notebook.', era:'notebook' },
  { id:'plate-iii', figure:'Plate III', caption:'Group portrait silhouette, c. 1879. Approximately forty muckers; Edison center, Batchelor at his left, Kruesi at right, Upton standing rear. The team was the instrument.', description:'Silhouette reconstruction of the Menlo Park team.', era:'team-1879' },
  { id:'plate-iv', figure:'Plate IV', caption:'Cadence chart: minor inventions per ten-day window across the Menlo Park decade (1876–1886). Each tick mark represents one patentable artifact. Visible in the chart: the bulb-work cluster of 1878–1879, the Pearl Street design phase of 1880, and the gradual taper toward the 1886 West Orange transition.', description:'A bar chart of invention cadence across the decade.', era:'cadence-chart' },
];
