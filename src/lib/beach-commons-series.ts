...
export const BEACH_COMMONS_SERIES = {
  ...
  id: 'PC-BEACH-COMMONS',
  title: 'Beach Commons',
  subtitle: 'Sixteen field studies for making public life at the edge.',
  dek: 'Architecture, games, weather, useful objects, radio, ecology, relays, a working harbor, fermentation, restoration, and two honest scoreboards—organized as a growing coastal commons.',
  url: 'https://pointcast.xyz/beach-commons',
  jsonUrl: 'https://pointcast.xyz/beach-commons.json',
  currentEdition: 16,
  currentUrl: 'https://pointcast.xyz/beach-commons/v16',
...
export const BEACH_COMMONS_EDITIONS: readonly BeachCommonsEdition[] = [
  ...
  },
  {
    ...
    subtitle: 'The oysters did not save the harbor. The project may have saved the idea of a harbor.',
    invitation: 'Score the civic commons and the living system separately, then carry the method west.',
