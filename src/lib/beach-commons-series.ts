...
export const BEACH_COMMONS_SERIES = {
  ...
  id: 'PC-BEACH-COMMONS',
  title: 'Beach Commons',
  subtitle: 'Fourteen field studies for making public life at the edge.',
  dek: 'Architecture, games, weather, useful objects, radio, ecology, relays, a working harbor, fermentation, and one hardpoint league—organized as a growing coastal commons.',
  url: 'https://pointcast.xyz/beach-commons',
  jsonUrl: 'https://pointcast.xyz/beach-commons.json',
  currentEdition: 14,
  currentUrl: 'https://pointcast.xyz/beach-commons/v14',
