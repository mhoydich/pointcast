...
export const BEACH_COMMONS_EDITIONS: readonly BeachCommonsEdition[] = [
  ...
  },
  {
    ...
    slug: 'v17',
    title: 'Ask the Beach',
    subtitle: 'The Commons Science Fair. Every booth proves one thing in public.',
    invitation: 'Choose why you came, build a route, and stay for blue-hour proof.',
    image: '/beach-commons/v17/assets/poster-01.png',
