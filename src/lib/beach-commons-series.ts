...
export const BEACH_COMMONS_SERIES = {
  ...
  id: 'PC-BEACH-COMMONS',
  title: 'Beach Commons',
  subtitle: 'Thirteen field studies for making public life at the edge.',
  dek: 'Architecture, games, weather, useful objects, radio, ecology, relays, a working harbor, and one fermentation league—organized as a growing coastal commons.',
  url: 'https://pointcast.xyz/beach-commons',
  jsonUrl: 'https://pointcast.xyz/beach-commons.json',
  currentEdition: 13,
  currentUrl: 'https://pointcast.xyz/beach-commons/v13',
