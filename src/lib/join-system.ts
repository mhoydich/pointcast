export const JOIN_SYSTEM = {
  ...
  thesis:
    'Map scattered human and creative identity, make it legible, then route collaboration, opportunity, capital, and expression through small claimable tasks.',
  loop: [
    {
      id: 'map',
      label: 'Map',
  ...
  projects: [
    {
      ...
      firstWedge:
        'A profile assembler for one creative/technical person. Input 5-8 links, output a beautiful identity map, collaboration suggestions, and a public page.',
      agentTasks: [
