...
A self-contained fantasy smoking and meditation companion for a quiet pause: timer, cozy visuals, ambient fire/rain/road/starlight audio, Noun-style Wizard Nouns collectibles, an optional "Myth" listen-along, original wizardly and nature prompts, lantern view, phase guidance, and a small local session log.
...
- Upgrades the tiny wizard avatar system to read more like actual Nouns: square heads, chunky noggles, blocky accessories, Noun build traits, plus wizard hat, beard, staff, orb, and rune layers derived from the framework.
- Adds Noun Wizard feature panels for Head, Noggles, Accessory, and Wand, plus a three-card Noun council.
- Adds new V7 actions for rolling noggles, summoning a council, and casting a Noun spell directly into the local spellbook.
