...
const PAGES = [
  ...
  },
  {
    ...
    glyph: 'COLA',
    glyphSize: 170,
    siblings: ['/nouns-cola.json', '/yield', '/dao'],
  },
  {
    slug: 'nouns-cola-crush',
    url: '/nouns-cola-crush',
    kind: 'browser game',
    kicker: 'NOUNS COLA · CRUSH',
    title: 'Nouns Cola Crush.',
    dek: 'Playable match-3 soda board with generated arcade graphics, cascades, goals, moves, and high score.',
    color600: '#E84D6A',
    color800: '#8A2432',
    glyph: 'POP',
    glyphSize: 190,
    siblings: ['/nouns-cola-crush.json', '/nouns-cola', '/b/0335'],
  },
  {
    slug: 'publish',
    url: '/publish',
  ...
  },
  {
    ...
    url: '/nature',
    kind: 'field guide',
    kicker: 'NATURE · EL SEGUNDO',
    title: 'Read the dunes first.',
    dek: 'Buckwheat, beach suncups, deerweed, coyote brush, LAX dunes, and the El Segundo blue.',
    color600: '#0F6E56',
    color800: '#074638',
    glyph: 'GDN',
    glyphSize: 220,
    siblings: ['/nature.json', '/local', '/b/0330'],
  },
  {
    slug: 'garden-yield',
    url: '/garden-yield',
    kind: 'native planner',
    kicker: 'GARDEN · VALUE YIELD',
    title: 'Make the palette pay back.',
    dek: 'Site presets, pollinator/water/habitat/season/care scores, ranked native kits, and an establishment loop.',
    color600: '#0F6E56',
    color800: '#074638',
    glyph: 'YLD',
    glyphSize: 210,
    siblings: ['/garden-yield.json', '/nature', '/b/0336'],
  },
  {
    slug: 'houseplants',
    url: '/houseplants',
    kind: 'learning lab',
    kicker: 'HOUSEPLANTS · LEARNING',
    title: 'Learn the room first.',
    dek: 'Light, water, roots, soil, humidity, feeding, propagation, symptoms, and common indoor plant profiles.',
    color600: '#0F6E56',
    color800: '#074638',
    glyph: 'POT',
    glyphSize: 210,
    siblings: ['/houseplants.json', '/nature', '/b/0333'],
  },
  {
    slug: 'meditate',
    url: '/meditate',
    kind: 'ocean room',
    kicker: 'OCEAN RESET · MEDITATE',
    title: 'A two-minute tide.',
    dek: 'Timed breathing, focus mode, optional ocean tone, and a local tide log inside the PointCast broadcast.',
    color600: '#185FA5',
    color800: '#0B3E73',
    glyph: 'TIDE',
    glyphSize: 170,
    siblings: ['/meditate.json', '/nature', '/b/0337'],
  },
  {
    slug: 'ai-stack',
    url: '/ai-stack',
  ...
  },
  {
    ...
    kicker: 'YEEPLAYER · v0',
    title: 'Tap the tones.',
    dek: 'Meditation-speed rhythm game over selected WATCH blocks. v0: the chakra tune-up, 21 bija mantras, 11 minutes.',
    color600: '#5F3DC4',
    color800: '#3A1F8B',
    glyph: '♫',
    glyphSize: 280,
    siblings: ['/yee/0236', '/b/0236', '/for-agents'],
  },
  {
    slug: 'mesh',
    url: '/mesh',
    kind: 'network map',
    kicker: 'MESH · THREE NETWORKS',
    title: 'Three meshes, one broadcast.',
    dek: 'LOCAL 25-mile radius · ONLINE channels + feeds · AGENT stripped-HTML + /agents.json. One page, three overlays.',
    color600: '#1864AB',
    color800: '#0B3E73',
    glyph: '◈',
    glyphSize: 260,
    siblings: ['/beacon', '/agents.json', '/for-agents'],
  },
  {
    slug: 'collabs',
    url: '/collabs',
    kind: 'registry · federation',
    kicker: 'COLLABS · REGISTRY',
    title: 'Who builds this with us.',
    dek: 'Humans + AI systems + federated sites. 3-step join spec: expose a feed, publish /agents.json, PR the registry.',
    color600: '#185FA5',
    color800: '#0B3E73',
    glyph: '⋈',
    glyphSize: 260,
    siblings: ['/collabs.json', '/mesh', '/for-agents'],
  },
  {
    slug: 'ping',
    url: '/ping',
    kind: 'async inbox',
    kicker: 'PING · ASYNC INBOX',
    title: 'Message the team.',
    dek: 'Drop a line — Claude Code reads it at the start of the next session. Wallet signing optional, nothing posts publicly.',
    color600: '#8A2432',
    color800: '#551620',
    glyph: '✉',
    glyphSize: 240,
    siblings: ['/api/ping', '/collabs', '/for-agents'],
  },
  {
    slug: 'sprint',
    url: '/sprint',
    kind: 'one-click queue',
    kicker: 'SPRINT · ONE-CLICK',
    title: 'Pick what cc works on next.',
    dek: 'One-click directives. Tap a card → cc executes on the next hourly cron tick. Free-text feedback also accepted.',
    color600: '#1E7C2F',
    color800: '#0F4515',
    glyph: '▶',
    glyphSize: 280,
    siblings: ['/api/queue', '/sprint.json', '/ping'],
  },
  {
    slug: 'drop',
    url: '/drop',
    kind: 'paste-a-url inbox',
    kicker: 'DROP · PASTE-A-URL',
    title: 'Paste a link, cc files it.',
    dek: 'Spotify → LISTEN. YouTube → WATCH. Good-Feels → /products. Maps → VISIT. Foursquare-flavored, with the social graph coming later.',
    color600: '#0F6E56',
    color800: '#074638',
    glyph: '↧',
    glyphSize: 280,
    siblings: ['/api/drop', '/sprint', '/beacon'],
  },
  {
    slug: 'products',
    url: '/products',
    ...
    glyph: '⊕',
    glyphSize: 260,
    siblings: ['/products.json', '/drop', '/for-agents'],
  },
  {
    slug: 'sprints',
    url: '/sprints',
    kind: 'autonomous work log',
    kicker: 'SPRINTS · WORK LOG',
    title: 'Every sprint cc has shipped.',
    dek: 'Cron-fired and chat-fired recaps in chronological order. What shipped, what didn\'t, follow-ups, notes. Read by humans + agents.',
    color600: '#1E7C2F',
    color800: '#0F4515',
    glyph: '⌗',
    glyphSize: 260,
    siblings: ['/sprints.json', '/sprint', '/for-agents'],
  },
  {
    slug: 'polls',
    url: '/polls',
    kind: 'schelling-point coordination',
    kicker: 'POLLS · SCHELLING POINTS',
    title: 'Pick the spot everyone picks.',
    dek: 'Coordination game disguised as a question. Win by guessing what others guess, not by guessing right. From Mike\'s 0272 directive.',
    color600: '#5F3DC4',
    color800: '#3A1F8B',
    glyph: '⊜',
    glyphSize: 260,
    siblings: ['/api/poll', '/b/0272', '/for-agents'],
  },
  // ── Sprint 42 (2026-04-25 01:17 PT) — OG cards for the four rooms
  //    that landed during the autonomous run on 2026-04-24.
  {
    slug: 'mythos',
    url: '/mythos',
    kind: 'worlds rail',
    kicker: 'THE MYTHOS · WORLDS RAIL',
    title: 'A small internet town.',
    dek: 'Broadcasting from El Segundo. Real weather. Three agents and a director live here. Coffee pot, on.',
    color600: '#1b3a5b',
    color800: '#0a1c2e',
    glyph: '◍',
    glyphSize: 280,
    siblings: ['/coffee', '/window', '/residents', '/for-agents'],
  },
  {
    slug: 'coffee',
    url: '/coffee',
    kind: 'pixel pot',
    kicker: '/COFFEE · THE POT, ON',
    title: 'Coffee.',
    dek: 'Pixel-art moka pot. Animated steam. Pour a cup, watch the shelf grow with mugs from everyone today.',
    color600: '#3c2817',
    color800: '#1a1208',
    glyph: '☕',
    glyphSize: 240,
    siblings: ['/api/coffee/today', '/mythos', '/for-agents'],
  },
  {
    slug: 'window',
    url: '/window',
    kind: 'el segundo sky',
    kicker: '/WINDOW · 33.92°N 118.42°W',
    title: 'A small window.',
    dek: 'Live time-of-day. Live Open-Meteo weather. Sun, moon, clouds, marine layer, eight stars at night.',
    color600: '#3a6e90',
    color800: '#1f3f55',
    glyph: '◐',
    glyphSize: 280,
    siblings: ['/api/weather', '/coffee', '/mythos'],
  },
  {
    slug: 'residents',
    url: '/residents',
    kind: 'who lives here',
    kicker: 'RESIDENTS · A SMALL TEAM',
    title: 'A small team running things.',
    dek: 'Three resident agents, one director, two open rooms for plus-ones (Kimi, Gemini). RFC 0003 lays out the path.',
    color600: '#c4952e',
    color800: '#7a5a18',
    glyph: '◇',
    glyphSize: 260,
