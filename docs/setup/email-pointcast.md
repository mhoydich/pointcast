...
- Run the dry-run-first PointCast Daily scheduler surface at `/email-scheduler`, `/email-scheduler.json`, and `/email-daily-preview.json`, plus the deployable worker in `workers/pointcast-daily-email`. See `docs/setup/daily-email-scheduler.md`.
