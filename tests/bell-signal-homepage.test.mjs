...
test('the rebuilt PointCast front door keeps the home-signals catalog and carries Nouns and Bell & Signal as live doors', async () => {
  const [home, desk, playFirst, signals, welcome] = await Promise.all([
  ...
  // from noun.pics, and Bell & Signal as a door on the drum shelf. The project welcome now carries the page h1.
