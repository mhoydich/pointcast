# Saturday Signal Stamps — Mainnet handoff

This is a 50-token FA2. Token IDs 0–49 are distinct field stamps. `mint_signal(token_id)` accepts exactly 0 mutez, caps each field at 100 editions, and permits one mint per wallet per token.
