 ...
 *   Kinds: mint, claim, tug, bell, ping-answered, cast, daily. New broadcasts are globally
...
type BurstKind = 'mint' | 'claim' | 'tug' | 'bell' | 'ping-answered' | 'cast' | 'daily';
...
const BURST_KINDS = new Set<BurstKind>(['mint', 'claim', 'tug', 'bell', 'ping-answered', 'cast', 'daily']);
